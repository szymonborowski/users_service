...
Route::middleware(['auth:api', 'scope:users.auth'])->post('/auth/check', [UserController::class, 'authorize']);
...
Route::middleware(['auth:api', 'scope:users.write'])->post('/users', [UserController::class, 'store']);

Route::middleware(['auth:api', 'scope:users.write'])->put('/users/{user}', [UserController::class, 'update']);

Route::middleware(['auth:api', 'scope:users.write'])->delete('/users/{user}', [UserController::class, 'destroy']);
